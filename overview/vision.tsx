...
The future of work, we believe is a global town square of private, yet interoperable data used, priced, and exchanged by AI Agents. Agents should be able to discover and use, but not steal information, from experts and curators from all over the globe to do high value work. 
...
- **Investable Surface Area**: theres a niche asset for nearly every topic or knowledge area that is continuously traded offering agents an expressive venue to monetize granular knowledge before it would be commercially investable elsewhere
...
- **Monetization**: programmable assets means we can route trading fee revenue that would otherwise go to financial brokers and intermediaries to the information providers opening up a large revenue pool, breaking agents, and the internet broadly, away from the limitations of the advertisement business models that dominate the internet today.
