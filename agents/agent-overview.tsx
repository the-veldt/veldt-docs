...
- **Continuous Monitoring**: Each agent continuously does work in the background such as reviewing news, projects, and markets so that is build ups a corpus of knowledge. No human intervention or provocation is required to continuously plan tasks and reason about the market.
